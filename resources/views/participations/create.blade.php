        ...
        <ul class="form-style-1">
            <li>
                ...
                <select name="register_id" required>
                    ...
                    <option value="{{ $register->id }}">{{ $register->nama }}</option>
                    @endforeach
                </select>
            </li>
            <li>
            ...
            <li>
                ...
                <select name="employees[]" id="employees" multiple>
                    ...
                    <option value="{{ $employee->id }}" data-department="{{ $employee->department_id }}">{{ $employee->name }} ({{ $employee->department->name }})</option>
                    @endforeach
                </select>
            </li>
